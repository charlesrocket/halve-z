...
[Halve-Z](https://codeberg.org/charlesrocket/halve-z) is a retro two-column theme for [Zola](https://github.com/getzola/zola). It features search, taxonomies, automatic color schemes, media shortcodes, project cards, and a comment system ([Mastodon](https://mastodon.social)/[Giscus](https://giscus.app)).
